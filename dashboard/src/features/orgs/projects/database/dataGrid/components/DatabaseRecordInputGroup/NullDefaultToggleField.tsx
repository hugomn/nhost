  ...
  return (
    <FormField
      ...
      render={({ field, fieldState }) => {
        ...
        const displayValue =
          isNull || field.value === POSTGRES_DEFAULT_PLACEHOLDER
            ? ''
            : (field.value ?? '');

        const inputPlaceholder = isNull ? 'NULL' : placeholder;
            ...
            >
              ...
              >
                ...
                <InputGroupAddon align="inline-end">
                  <InputGroupButton onClick={handleNullToggle}>
                    {isNull ? 'Set to DEFAULT' : 'Set to NULL'}
                  </InputGroupButton>
                </InputGroupAddon>
              </InputGroup>
              {!!helperText && (
